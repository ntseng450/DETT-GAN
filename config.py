...
def load_args():
    ...
    arg_parser.add_argument('--add_noise', action='store_true')
    ...
    arg_parser.add_argument('--epoch_snapshots', default=10, type=int)

    # Testing Params
    arg_parser.add_argument('--is_test', action='store_true')
    arg_parser.add_argument('--isTrain', action='store_true')

    # Temp
    arg_parser.add_argument('--dataroot', default='placeholder',
    ...
    # model parameters
    arg_parser.add_argument('--model', type=str, default='cut', help='chooses which model to use.')
    ...
    # dataset parameters
    arg_parser.add_argument('--dataset_mode', type=str, default='unaligned',
    ...
    arg_parser.add_argument('--num_threads', default=4, type=int, help='# threads for loading data')
    arg_parser.add_argument('--load_size', type=int, default=286, help='scale images to this size')
    arg_parser.add_argument('--crop_size', type=int, default=256, help='then crop to this size')
    arg_parser.add_argument('--max_dataset_size', type=int, default=float("inf"),
                        help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
    arg_parser.add_argument('--display_winsize', type=int, default=256, help='display window size for both visdom and HTML')
    arg_parser.add_argument('--random_scale_max', type=float, default=3.0,
    ...
    arg_parser.add_argument('--suffix', default='', type=str,
                        help='customized suffix: opt.name = opt.name + suffix: e.g., {model}_{netG}_size{load_size}')

    arg_parser.add_argument('--display_freq', type=int, default=400, help='frequency of showing training results on screen')
    arg_parser.add_argument('--display_ncols', type=int, default=4,
                        help='if positive, display all images in a single visdom web panel with certain number of images per row.')
    arg_parser.add_argument('--display_id', type=int, default=None,
                        help='window id of the web display. Default is random window id')
    arg_parser.add_argument('--display_server', type=str, default="http://localhost",
                        help='visdom server of the web display')
    arg_parser.add_argument('--display_env', type=str, default='main',
                        help='visdom display environment name (default is "main")')
    arg_parser.add_argument('--display_port', type=int, default=8097, help='visdom port of the web display')
    arg_parser.add_argument('--update_html_freq', type=int, default=1000,
                        help='frequency of saving training results to html')
    arg_parser.add_argument('--print_freq', type=int, default=1, help='frequency of showing training results on console')
    arg_parser.add_argument('--no_html', action='store_true',
                        help='do not save intermediate training results to [opt.checkpoints_dir]/[opt.name]/web/')
    # network saving and loading parameters
    arg_parser.add_argument('--save_latest_freq', type=int, default=5000, help='frequency of saving the latest results')
    arg_parser.add_argument('--save_epoch_freq', type=int, default=5,
                        help='frequency of saving checkpoints at the end of epochs')
    arg_parser.add_argument('--evaluation_freq', type=int, default=5000, help='evaluation freq')
    arg_parser.add_argument('--save_by_iter', action='store_true', help='whether saves model by iteration')
    ...
    arg_parser.add_argument('--phase', type=str, default='train', help='train, val, test, etc')
    arg_parser.add_argument('--pretrained_name', type=str, default=None, help='resume training from another checkpoint')
    ...
    arg_parser.add_argument('--lambda_GAN', type=float, default=1.0, help='weight for GAN loss：GAN(G(X))')
