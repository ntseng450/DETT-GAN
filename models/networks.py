...
class ScaleDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, netD="coarse", n_layers=3, norm_layer=nn.BatchNorm2d, no_antialias=False):
...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
    ...
    elif netD == 'coarse' or netD == 'medium':
        net = ScaleDiscriminator(input_nc, ndf, netD, n_layers_D, norm_layer=norm_layer, no_antialias=no_antialias)
